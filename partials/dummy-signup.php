...
if ($method == "POST") {
    ...
    if ($numExistsRows > 0) {
        ...
        if (($pass == $cpass)) {
            ...
            header("location: /GCA_QUORA/login.php");
            exit();
        }
    }
}
...
<body>
    ...
    <div class="container my-4">
        ...
        <div class="signup-container my-4">
            <form action="/GCA_QUORA/dummy.php" method="post">
                <div class="mb-3 my-3 content row">
                    ...
                    <input type="text" class="form-control col-lg-11 col-md-11 col-sm-11" id="name" name="name" aria-describedby="emailHelp" placeholder="Enter Your Username">
                </div>
                <div class="mb-3 my-3 content row">
