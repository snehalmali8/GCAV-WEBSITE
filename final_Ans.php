        ...
        echo '</div>
            <div class="container my-2 answers">
                <div class="media my-4">
                    ...
                    <a class="ans-icon" title="delete" href="Ans_delete.php?queid=' . $row['que_id'] . '"><i class="fas fa-trash"></i>
                    <a class="ans-icon" title="edit" href="kishya_edit.php?queid=' . $row['que_id'] . '"><i class="fas fa-edit"></i>
                    </a>
